			...
			try {
				while(true) {
					try {
						...
						if(request.getType().equals(Type.PUT)) {
							response = controller.put(request.getName(),request.getAge()+"");
						} else if(request.getType().equals(Type.GET)) {
							response = controller.get(request.getName());
						} else if(request.getType().equals(Type.LIST)) {
							response = controller.list();
						} else if(request.getType().equals(Type.REMOVE)) {
